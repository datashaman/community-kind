...
class OrganisationName implements ValidationRule
{
    /**
    ...
    public function validate(string $attribute, mixed $value, Closure $fail): void
    {
        ...
        if (Str::slug($name) === '') {
            $fail(__('This organisation name must contain at least one letter or number.'));

            return;
        }

        if (in_array($name, $this->reservedNames(), true)) {
            $fail(__('This organisation name is reserved and cannot be used.'));
        }
    }
